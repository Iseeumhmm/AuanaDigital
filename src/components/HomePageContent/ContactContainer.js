      ...
      <ContactContainer clicked={props.clicked}>
        ...
        <div>
          <div>
            ...
            As a front end developer and web designer, auana has helped me to forge many skillsets and given me versatility. From digital design to photography and videography, lending me a higher-level perspective of website development as a whole. <br />
            Serving London </p>
          </div>
        </div>
        <div>
          <div>
            <h1>Drone Photography &amp; Videography</h1>
            <iframe  src="https://www.youtube-nocookie.com/embed/wVF9bCzr7-s" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
