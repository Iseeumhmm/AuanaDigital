...
// import { TweenMax, TimelineMax, Elastic, Back, interpolate } from "gsap";

import ScrollMagic from 'scrollmagic/scrollmagic/uncompressed/ScrollMagic'
import { TweenMax, TimelineMax, Elastic, Back, interpolate } from 'scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap'
...
.intro {
 ...
 #ahi path:nth-child(2){
   ...
   animation: ${letterAnimation} 2s ease forwards 2.3s; 
 }
 #ahi path:nth-child(3){
   stroke-dasharray: 216.8;
   stroke-dashoffset: 216.8;
   animation: ${letterAnimation} 2s ease forwards 4.2s; 
 }
 `
...
export default function Blog() {
  ...
  let ahiContainer = useRef(null)
  let markdownArea = useRef(null)
  ...
  useEffect(() => {
    ...
    const pushCards = TweenMax.to(videoContainer, 3, { left: "500%" })
    ...
    let videoEle = video
    scene.on("update", e => {
      console.log('ps:', e.scrollPos / 100)
      // console.log(videoEle)
      videoEle.currentTime = e.scrollPos / 100
    })
  ...
  return (
    <Container>
      <PageContainer ref={element => { pageContainer = element; }} id="page_container">
        <Head>
          <meta property="og:locale" content="en_CA" />
          <meta property="og:title" content="Website Interaction - Scroll Animations" />
          <meta property="og:type" content="website" />
          <meta property="og:site_name" content="Auana Digital" />
          <meta property="og:description" content="Playing with fire, I promise you won't get burnt!" />
          <meta property="og:url" content="https://auana.ca/blog/website-interaction/scroll-animations" />
          <meta property="og:image" content="http://auana.ca/images/" />
          <meta property="og:image:width" content="1920" />
          <meta property="og:image:secure_url" content="https://auana.ca/images/" />
        ...
        <div className="content_container">
          ...
          <div className="action_container">
            ...
            <div ref={element => { videoContainer = element; }} className="intro">
              <div className="video_container">
                <video ref={element => { video = element; }} id="video" src={cinemagraph}></video>
              </div>
            </div>
            <wired-card style={{ width: "calc(100% - 4rem)", margin: "auto" }} elevation="3">
              <div ref={element => { ahiContainer = element; }} className="ahi_container">
          ...
          <div ref={element => { markdownArea = element; }} >
